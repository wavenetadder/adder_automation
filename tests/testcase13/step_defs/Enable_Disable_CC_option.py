...
scenarios('../features/Enable_Disable_CC_option.feature')
# scenarios('D:\pythonProject\adderCode1\tests\testcase13\features\Enable_Disable_CC_option.feature')
...
def user_click_the_checkbox_show_current_channel_yes():
    driver.find_element_by_xpath('//*[@id="show_osd_banner_1"]').click()
    print("click done on the checkbox show current channel yes")
    allure.attach(driver.get_screenshot_as_png(), name='screenshot',
                  attachment_type=allure.attachment_type.PNG)
    time.sleep(5)
...
def user_click_the_checkbox_show_current_channel_no():
    driver.find_element_by_xpath('//*[@id="show_osd_banner_0"]').click()
    print("click done on the checkbox show current channel no")
    allure.attach(driver.get_screenshot_as_png(), name='screenshot',
                  attachment_type=allure.attachment_type.PNG)
    driver.execute_script("window.scrollTo(0,800)")
    time.sleep(3)