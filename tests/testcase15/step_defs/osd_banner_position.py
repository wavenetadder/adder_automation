...
scenarios('../features/osd_banner_position.feature')
# scenarios('D:\pythonProject\adderCode1\tests\testcase15\features\osd_banner_position.feature')
...
def user_change_the_banner_position():
    banner = Select(driver.find_element_by_xpath('//*[@id="osd_banner_pos"]'))
    banner.select_by_visible_text("Bottom Left")
    print("banner position is changed")
    allure.attach(driver.get_screenshot_as_png(), name='screenshot',
                  attachment_type=allure.attachment_type.PNG)
    time.sleep(3)
...
def user_again_change_the_banner_position():
    banner = Select(driver.find_element_by_xpath('//*[@id="osd_banner_pos"]'))
    banner.select_by_visible_text("Top Centre")
    print("banner position is changed")
    allure.attach(driver.get_screenshot_as_png(), name='screenshot',
                  attachment_type=allure.attachment_type.PNG)
    time.sleep(3)
