...
# scenarios('D:\pythonProject\adderCode1\tests\testcase11\features\syslog.feature')
...
def user_enable_the_syslog():
    driver.find_element_by_xpath('//*[@id="syslog_enabled_1"]').click()
    print("click on syslog enable done")
    time.sleep(2)
...
def user_enable_the_syslog():
    driver.find_element_by_xpath('//*[@id="syslog_enabled_0"]').click()
    print("click on syslog disable done")
    time.sleep(2)
